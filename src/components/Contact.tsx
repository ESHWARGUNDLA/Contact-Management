...
const Contact = () => {
  ...
  const renderNoContactAvailable = () => {
    return (
      <div className="bg-[#101010] p-5 flex flex-col items-center md:h-screen md:w-full justify-center text-[#36454F]">
        <button
          type="button"
          className="font-bold md:text-2xl text-1xl bg-white px-[20px] py-[15px] rounded-[15px] hover:bg-[#080808] hover:text-white"
